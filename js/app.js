...
// VERSION & BUILD INFO
// ============================================================================
const APP_VERSION = 'v0.24.0a2';
const BUILD_DATE = new Date('2025-12-05T16:55:00'); // Format: YYYY-MM-DDTHH:mm:ss
...
function updateDevBanner() {
    ...
    // Only show banner for development versions (starts hidden in HTML)
